...
def createFigure(array,labels,outPath, n):
    ...
    ax = sns.heatmap(df, cmap='PuOr', linewidths=1, annot=False, cbar_kws={"shrink": 0.5})
    ax.set_xlabel('Site Pattern')
    ax.set_ylabel('Scenario')
    ax.set_xticklabels(ax.get_xticklabels(), minor=False, fontsize=8)
    plt.tight_layout()
