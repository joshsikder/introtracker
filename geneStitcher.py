...
def Write_Fasta(Dict):
    ...
    SuperMatrix = open(arguments.matrixoutput, 'w')
...
if __name__ == "__main__":
    ...
    parser.add_argument('-matout', dest = 'matrixoutput', type = str, help = 'Output directory and filename for supermatrix')
    parser.add_argument('-partout', dest = 'partitionoutput', type = str, help = 'Output directory and filename for partition file')
    arguments = parser.parse_args()
    Delim = arguments.delimiter
    Targets = arguments.alignments
    # Log = open('StitcherLog.out', 'w+')
    Part = open(arguments.partitionoutput, 'w+')
