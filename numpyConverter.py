...
def main():
    ...
    parser.add_argument( '--trout', help = "Training output",dest='TROUT')
    parser.add_argument( '--teout', help = "Test output",dest='TEOUT')
    ...
    np.save(args.TROUT, train_data1)
    np.save(args.TEOUT, test_data1)
